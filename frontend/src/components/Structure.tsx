        ...
        <div className="flex  justify-center">
           ...
           <div className="font-semibold mt-1 text-slate-400 ml-1 ">
            ...
            <div>
                ...
                <div className="pt-2">
                <div>
                   {type=="signup"? <InputBox label={"Username"} placeholder={"Enter your usnername"} onChange={(e)=>{
                        setpostInputs({
                            ...postInputs,
                            name:e.target.value
                        })
                ...
                <button onClick={sendRequest} className="bg-black text-white w-full p-2 mt-4 rounded-md">{type=="signup"?"Sign Up":"Sign In"}</button>
